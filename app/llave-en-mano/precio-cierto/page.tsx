...
export default function PrecioCiertoPage() {
  return (
    <div className="min-h-screen">
      ...
      <main className="mt-20">
        <section className="relative h-[400px] bg-secondary">
          <img src="/budget-planning.jpg" alt="Precio cierto en construcción" className="w-full h-full object-cover" />
          ...
          <div className="absolute inset-0 flex items-center">
            <div className="container mx-auto px-4 lg:px-8">
              ...
              <div className="flex items-center gap-4 mb-4">
                ...
                <h1 className="text-5xl lg:text-6xl font-bold text-primary-foreground">Precio Cierto</h1>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4 lg:px-8">
            <div className="max-w-4xl mx-auto">
              <p className="text-lg text-muted-foreground leading-relaxed">
                Contenido detallado sobre Precio Cierto próximamente...
              </p>
            </div>
          </div>
        </section>

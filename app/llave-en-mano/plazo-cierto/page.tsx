...
export default function PlazoCiertoPage() {
  return (
    <div className="min-h-screen">
      ...
      <main className="mt-20">
        <section className="relative h-[400px] bg-secondary">
          <img
            src="/construction-timeline.jpg"
            alt="Plazo cierto en construcción"
          ...
          <div className="absolute inset-0 flex items-center">
            <div className="container mx-auto px-4 lg:px-8">
              ...
              <div className="flex items-center gap-4 mb-4">
                ...
                <h1 className="text-5xl lg:text-6xl font-bold text-primary-foreground">Plazo Cierto</h1>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4 lg:px-8">
            <div className="max-w-4xl mx-auto">
              <p className="text-lg text-muted-foreground leading-relaxed">
                Contenido detallado sobre Plazo Cierto próximamente...
              </p>
            </div>
          </div>
        </section>
